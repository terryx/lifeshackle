...
<!--<h2>final test creation</h2><div class="created" />Created on 2012-01-11 17:45:26</div>-->
<script>
	function fetchArticle(number){
		$.ajax({
			type: 'GET',
			url: '<?php echo $data['baseurl']; ?>article/fetch-article/'+number,
